...
The analysis was conducted using the **Fitbit Fitness Tracker Data** publicly available on [Fitbit Fitness Tracker Data by Möbius (CC0: Public Domain)](https://www.kaggle.com/datasets/arashnic/fitbit).

**Dataset Details:**
- **Time Period**: March 12, 2016 – May 12, 2016 (split into two export folders)
...
The cleaned dataset was imported into **Tableau Public** for analysis and visualization.
...
1. **Distribution of Users Activity Levels**
...
3. **Average Steps by Day of Week**
    ...
    Users are most active on weekends, with Saturday and Sunday showing the highest average steps. Activity is lowest midweek.
...
5. **Average Steps Per Hour of the Day**
    ...
    Activity is lowest in the early morning and peaks in the evening hours (around 7-8 PM).
